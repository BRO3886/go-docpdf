Write a journal entry for today's work session on the `go-docpdf` project.
...
- **`CLAUDE.md`** — Update implementation status, coverage numbers, and any new architecture/patterns added during the session.
