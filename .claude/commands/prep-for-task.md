Bootstrap context for a new session on the `go-docpdf` project. Run this BEFORE starting any implementation work.
...
```
## Project State
- Packages implemented: <list>
- Packages remaining: <list>
...
## Rules
- **ALWAYS read `CLAUDE.md` yourself (not via subagent) before launching any agents** — it contains critical project context, conventions, and non-negotiables that you must internalize directly
